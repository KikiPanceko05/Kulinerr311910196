package com.example.kulinerr311910196;
...
public class DataKuliner {
        ...
        public static String[][] data = new String[][]{
                ...
                {"Kue Putu", "Kue putu adalah jenis kudapan tradisional Indonesia berupa kue dengan isian gula jawa, dibalut dengan parutan kelapa, dan tepung beras butiran kasar. Kue ini di kukus dengan diletakkan di dalam tabung bambu yang sedikit dipadatkan. Kue ini dijual pada saat matahari terbenam sampai larut malam. Suara khas uap yang keluar dari alat suitan ini sekaligus menjadi alat promosi bagi pedagang yang berjualan. " +
                        ...
                        "" +
                        "Melalui diaspora Jawa dan Bugis, kue putu juga dipopulerkan ke negara lain oleh orang Jawa dan Bugis, seperti ke Singapura dan Malaysia.", "https://upload.wikimedia.org/wikipedia/commons/d/da/22._Ku%C3%A9_putu_1.jpg"},

                {"Kue Satu", "Kue satu (di Jawa Barat, Banten, dan Jakarta) atau kue koya (di Jawa Tengah dan Jawa Timur) adalah sebuah kue kering tradisional berwarna putih yang bertekstur renyah dan sedikit keras. Makanan ini populer di Indonesia namun asal-usulnya tidak diketahui secara pasti.", "https://t-2.tstatic.net/tribunnewswiki/foto/bank/images/Kue-Satu.jpg"},
